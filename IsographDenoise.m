function [acc01Mean acc01DMean acc01DIMean accMLMean accMLDMean accMLDIMean] = IsographDenoise(dataset,k)
...
while (err > eps) && (t < maxIter)
	...
	WDenoisingI = IsographReweight(WDenoisingW, Wk, WDenoisingW > 0, n, 2.0,3,0.5,1);
